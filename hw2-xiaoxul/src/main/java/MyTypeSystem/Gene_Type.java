...
public class Gene_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("MyTypeSystem.Gene");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "MyTypeSystem.Gene");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "MyTypeSystem.Gene");
