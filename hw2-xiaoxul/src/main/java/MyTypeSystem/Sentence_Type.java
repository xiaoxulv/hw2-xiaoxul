...
public class Sentence_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("MyTypeSystem.Sentence");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "MyTypeSystem.Sentence");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "MyTypeSystem.Sentence");
