...
public class Genetag_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("MyTypeSystem.Genetag");
  ...
  public String getID(int addr) {
      ...
      jcas.throwFeatMissing("ID", "MyTypeSystem.Genetag");
  ...
  public String getContent(int addr) {
      ...
      jcas.throwFeatMissing("Content", "MyTypeSystem.Genetag");
